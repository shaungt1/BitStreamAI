# --- minimal torchvision shim with built-in NMS (so no CUDA ops needed)
import sys, types
import torch
try:
...
# INPUT: your existing MediaMTX camera stream
RTSP_IN  = "rtsp://192.168.7.166:8554/live/cam?rtsp_transport=tcp"

# OUTPUT: publish annotated stream back to MediaMTX over RTSP
...
if not cap.isOpened():
    print("Failed to open input:", RTSP_IN); sys.exit(1)
...
try:
    ...
    while True:
        ...
        try:
            ...
            print("FFmpeg pipe closed."); break
